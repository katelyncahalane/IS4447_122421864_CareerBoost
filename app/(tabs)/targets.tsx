  ...
  return (
    <ThemedView style={styles.flex}>
      <HeroBanner
        ...
        title="Targets"
        tagline="Weekly and monthly application-count goals — global or per category — with progress, remaining, and clear met / exceeded / unmet states."
      />
        ...
        <View
          ...
          <ThemedText style={styles.summaryText}>
            {summary.currentCount === 0
              ? 'No targets use the current calendar week or month — scroll for other periods or add one with “This week” / “This month”.'
