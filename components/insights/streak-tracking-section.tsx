        ...
        <View
          ...
          <View style={styles.tileMetrics}>
            <View style={styles.metricCol}>
              ...
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Current · days</ThemedText>
            </View>
            <View style={styles.metricCol}>
              <ThemedText style={[styles.bigNum, { color: palette.text }]}>{loggingStreak.best}</ThemedText>
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Best · days</ThemedText>
            </View>
          </View>
        </View>
        ...
        <View
          ...
          <View style={styles.tileMetrics}>
            <View style={styles.metricCol}>
              ...
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Current · weeks</ThemedText>
            </View>
            <View style={styles.metricCol}>
              <ThemedText style={[styles.bigNum, { color: palette.text }]}>{weeklyTargetStreak.best}</ThemedText>
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Best · weeks</ThemedText>
            </View>
          </View>
        </View>
        ...
        <View
          ...
          <View style={styles.tileMetrics}>
            <View style={styles.metricCol}>
              ...
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Current · months</ThemedText>
            </View>
            <View style={styles.metricCol}>
              <ThemedText style={[styles.bigNum, { color: palette.text }]}>{monthlyTargetStreak.best}</ThemedText>
              <ThemedText style={[styles.metricLab, { color: palette.icon }]}>Best · months</ThemedText>
            </View>
          </View>
        </View>
      </View>
